...
const Hero = () => {
    return (
        <div className="flex flex-col items-center mt-6 lg:mt-20">
            ...
            <p className="bg-gradient-to-r from-orange-500 to-red-700 text-transparent bg-clip-text"> ** WE Thinc for you **</p>

            <div className="flex justify-center my-10">
                <a href="#" className="bg-gradient-to-r from-orange-500 to-orange-800 py-3 px-4 mx-3 rounded-md">
                    Start for free
                </a>
                <a href="#" className="py-3 px-4 mx-3 rounded-md border  align-text-center">
                    Documentation
                </a>
            </div>
